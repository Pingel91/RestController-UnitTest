...
namespace RestControllerPairProgramming
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MusicRecordsContext>(opt => opt.UseSqlServer(MySecret.ConnectionStrintAzure));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RestControllerPairProgramming v1"));
            }
